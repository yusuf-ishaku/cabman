        ...
        <ScrollView>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.form}>
              ...
              <View style={{marginHorizontal: 10, marginBottom: 10, fontFamily: styles.input.fontFamily}}>
              <PhoneInput
                defaultValue="+234"
                value={inputValue}
            ...
            <View style={{ alignItems: "center" }}>
              <Text style={{ fontSize: 15, marginTop: 10, fontFamily: "Poppins_400Regular" }}>
                Don't have an account?{" "}
                <Text onPress={() => navigation.navigate("SignUp")} style={{ color: "blue" }}>Register</Text>
              </Text>
            </View>
          </View>
        </ScrollView>
